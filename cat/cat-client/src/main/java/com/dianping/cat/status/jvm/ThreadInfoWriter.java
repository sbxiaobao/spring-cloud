...
public class ThreadInfoWriter {
    ...
    public static void main(String[] args) {
        ...
        ThreadInfoWriter writer = new ThreadInfoWriter();
        String threadsInfo = writer.buildThreadsInfo(threads);
        ...
        for (ThreadInfo thread : threads) {
            ...
            for (StackTraceElement ele : elements) {
                sb.append(ele.getClassName() + "." + ele.getMethodName());
            }
            System.out.println(sb.toString());
//            System.out.println(thread.getThreadName() + ":" + thread.getStackTrace());
        }
    }
}